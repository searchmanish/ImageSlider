package com.softcodeinfotech.imageslider;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sliderItems.add(new SliderItem(R.drawable.image9));
        sliderItems.add(new SliderItem(R.drawable.image_10));
        sliderItems.add(new SliderItem(R.drawable.image11));
        sliderItems.add(new SliderItem(R.drawable.image_12));
        sliderItems.add(new SliderItem(R.drawable.image14));
